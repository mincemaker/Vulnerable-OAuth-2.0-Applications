...
// copied alongside it at runtime. public/uploads/ is deliberately NOT
// embedded here -- it is a writable, runtime-mutable directory (new
// uploads land there), which go:embed's read-only filesystem can't serve.
package web
